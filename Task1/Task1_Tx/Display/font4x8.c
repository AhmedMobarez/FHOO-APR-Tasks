...
const uint8_t font4x8[] PROGMEM = {
    //0x0A, 0xEC, // Font size in bytes  : 2796=Anzahl Zeichen*Breite*8+Anzahl Zeichen(Bytes für Breite)+6
    0x00, 0x00, // Font size in bytes  : 2796=Anzahl Zeichen*Breite*8+Anzahl Zeichen(Bytes für Breite)+6
    0x04, // width
    0x08, // height
    0x20, // first char
    0x5F, // Font used chars     : 94

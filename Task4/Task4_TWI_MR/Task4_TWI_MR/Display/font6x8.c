...
const uint8_t font6x8[] PROGMEM = {
    //0x02, 0x1F, // Font size in bytes  : 671=Anzahl Zeichen*Bytes pro Zeichen+Anzahl Zeichen(Bytes für Breite)+6(Definition) (95*6+95+6)
    0x00, 0x00, // Font size in bytes  : 671=Anzahl Zeichen*Bytes pro Zeichen+Anzahl Zeichen(Bytes für Breite)+6(Definition) (95*6+95+6)
    0x06, // width
    0x08, // height
    0x20, // first char
    0x5F, // Font used chars     : 95
